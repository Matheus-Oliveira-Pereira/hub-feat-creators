...
/**
 * Verifica {@link RequirePermission} em handlers de controller. Roda fora do escopo do
 * {@code TenantAspect} (Order 1 vs 3 do tenant) — não precisa estar dentro de transação.
 */
@Aspect
@Component
@Order(1)
public class RequirePermissionAspect {
  ...
  @Around("@annotation(com.hubfeatcreators.infra.security.rbac.RequirePermission) "
  ...
  public Object check(ProceedingJoinPoint pjp) throws Throwable {
    ...
    boolean ok = anno.mode() == RequirePermission.Mode.ALL_OF
