...
public class Perfil {
  ...
  public Perfil(UUID assessoriaId, String nome, String descricao, Set<String> roles, boolean isSystem) {
  ...
  public void setRoles(Set<String> next) { this.roles = next.toArray(new String[0]); }
