...
public class ProspeccaoController {
    ...
    public record StatusRequest(
            @NotNull ProspeccaoStatus status, MotivoPerda motivoPerda, String motivoPerdaDetalhe) {}
    ...
    public EventoResponse comentar(
        ...
        return new EventoResponse(
                e.getId(), e.getTipo(), e.getPayload(), e.getAutorId(), e.getCreatedAt());
    }
    ...
    public void exportCsv(
        ...
        try (OutputStream os = response.getOutputStream();
            ...
            w.write('﻿');
            w.write(
                    "id,titulo,status,marca_id,influenciador_id,assessor_id,"
            ...
            while (written < max) {
                Page<Prospeccao> chunk =
                        service.listar(
                                principal, status, assessorId, marcaId, nome, page, pageSize);
    ...
    private String toCsvRow(Prospeccao p) {
        return String.join(
                ...
                csv(
                        p.getValorEstimadoCentavos() != null
                                ? p.getValorEstimadoCentavos().toString()
                                : ""),
