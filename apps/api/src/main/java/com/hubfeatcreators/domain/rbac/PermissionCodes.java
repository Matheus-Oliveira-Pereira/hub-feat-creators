 ...
 *
 * <p>Formato: [B|C|E|D] + 3 letras de entidade. Roles especiais 4-letras quando justificado
 * (OWNR, INVT, EXPT, BLLG).
 *
...
public final class PermissionCodes {
  ...
  public static final Set<String> ALL =
      Set.copyOf(
          List.of(
              OWNR, INVT, EXPT, BLLG,
              B_PRO, C_PRO, E_PRO, D_PRO,
              B_MAR, C_MAR, E_MAR, D_MAR,
              B_INF, C_INF, E_INF, D_INF,
              B_CON, C_CON, E_CON, D_CON,
              B_USU, C_USU, E_USU, D_USU,
              B_PRF, C_PRF, E_PRF, D_PRF,
              B_TAR, C_TAR, E_TAR, D_TAR,
              B_EML, C_EML, E_EML, D_EML,
              B_REL));
  ...
  public static final Set<String> ASSESSOR_DEFAULT =
      Set.of(B_PRO, C_PRO, E_PRO, B_MAR, B_INF, B_CON, C_CON, E_CON, B_USU, B_REL, B_TAR, C_TAR, E_TAR, B_EML, C_EML, E_EML);
