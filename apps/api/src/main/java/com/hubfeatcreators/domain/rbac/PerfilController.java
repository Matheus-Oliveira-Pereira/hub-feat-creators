...
public class PerfilController {
  ...
  public PerfilResponse criar(
      @AuthenticationPrincipal AuthPrincipal principal, @Valid @RequestBody PerfilRequest req) {
  ...
  public PerfilResponse atualizar(
    ...
    return toResponse(service.atualizar(principal, id, req.nome(), req.descricao(), req.roles()));
  }
