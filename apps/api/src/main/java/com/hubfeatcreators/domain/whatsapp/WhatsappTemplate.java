...
public class WhatsappTemplate {
    ...
    public String getMetaTemplateId() {
    ...
    public void setMetaTemplateId(String v) {
        this.metaTemplateId = v;
    }
    ...
    public void setSubmetidoEm(Instant v) {
        this.submetidoEm = v;
    }
    ...
    public void setCorpo(String v) {
        this.corpo = v;
    }

    public void setVariaveis(String[] v) {
        this.variaveis = v;
    }
}
