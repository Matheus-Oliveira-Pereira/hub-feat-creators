...
public class ProspeccaoService {
  ...
  public Prospeccao buscar(AuthPrincipal principal, UUID id) {
    Prospeccao p = repo.findById(id).orElseThrow(() -> BusinessException.notFound("PROSPECCAO"));
  ...
  public Prospeccao criar(
    ...
    Prospeccao p = new Prospeccao(
        principal.assessoriaId(),
        marcaId,
        assessorResponsavelId != null ? assessorResponsavelId : principal.usuarioId(),
        titulo,
        principal.usuarioId());
    ...
    Counter.builder("prospeccoes_criadas_total")
  ...
  public Prospeccao atualizar(
    ...
    p.setAssessorResponsavelId(
        assessorResponsavelId != null ? assessorResponsavelId : p.getAssessorResponsavelId());
    p.setTitulo(titulo);
    p.setValorEstimadoCentavos(valorEstimadoCentavos);
    p.setProximaAcao(proximaAcao);
    p.setProximaAcaoEm(proximaAcaoEm);
