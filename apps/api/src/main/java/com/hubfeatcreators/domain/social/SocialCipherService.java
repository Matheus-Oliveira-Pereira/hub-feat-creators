...
@Service
public class SocialCipherService {
    ...
    public SocialCipherService(@Value("${app.secrets.social-key}") String rawKey) {
    ...
    public Encrypted encrypt(String plaintext) {
        try {
            ...
            throw new IllegalStateException("Social cipher encrypt failed", e);
        }
    }
    ...
    public String decrypt(byte[] ciphertext, byte[] nonce) {
        try {
            ...
            throw new IllegalStateException("Social cipher decrypt failed", e);
        }
    }
}
