...
class MatchScorerTest {
    ...
    private final Map<String, Double> weights = Map.of("w1", 0.40, "w2", 0.25, "w3", 0.20, "w4", 0.15);

    @Test
    void score_perfect_match() {
        Briefing briefing = buildBriefing("MODA", "AWARENESS", "REELS");
        CreatorProfileFeature features = buildFeatures("MODA", BigDecimal.valueOf(8.0), BigDecimal.valueOf(25));
    ...
    void score_zero_similarity_lowers_total() {
        ...
        CreatorProfileFeature features = buildFeatures("MODA", BigDecimal.valueOf(3.0), BigDecimal.valueOf(10));
    ...
    void channelHealthScore_uses_engagement_and_freq() {
        CreatorProfileFeature features = new CreatorProfileFeature(UUID.randomUUID(), UUID.randomUUID());
    ...
    private Briefing buildBriefing(String vertical, String objetivo, String formato) {
        return new Briefing(UUID.randomUUID(), UUID.randomUUID(), vertical, objetivo, null, formato, null, null, null);
    }

    private CreatorProfileFeature buildFeatures(String vertical, BigDecimal engagement, BigDecimal freq) {
